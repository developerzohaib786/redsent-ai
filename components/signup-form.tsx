    ...
    <>
      <form onSubmit={handleSubmit} className={cn("flex flex-col gap-6", className)} {...props}>
        ...
        <div className="grid gap-6">
          ...
          <Button type="submit" className="w-full bg-[#FF5F1F] text-white hover:bg-[#e34f14] transition cursor-pointer">
            Register
          </Button>
      ...
      <AlertDialog open={isopen} onOpenChange={setisopen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Password Miss Match</AlertDialogTitle>
            <AlertDialogDescription>
